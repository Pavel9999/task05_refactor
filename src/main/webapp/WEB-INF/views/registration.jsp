...
<div class="wrapper">
  ...
  <form name="form" action="/controller" method="post" onsubmit="return validate()">
      ...
      <div>
        ...
        <input class="user-input" type="text" name="first_name" id="name" placeholder="My first  name is"  />
		<label class="user" for="text">
           <svg viewBox="0 0 32 32">
                    <g filter="">
                      <use xlink:href="#man-people-user"></use>
        ...
        <input class="user-input" type="text" name="second_name" id="name" placeholder="My second name is"  />
		<label class="user" for="text">
           <svg viewBox="0 0 32 32">
                    <g filter="">
                      <use xlink:href="#man-people-user"></use>
        ...
        <input class="user-input" type="text" name="last_name" id="name" placeholder="My last name is"  />
	  ...
	  <label class="user" for="text">
        ...
        <input type="password" name="conpassword" id="name" placeholder="repeat password" />
      </div> 
     <div>
