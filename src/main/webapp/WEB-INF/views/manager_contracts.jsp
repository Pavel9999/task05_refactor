...
<form action="/controller" method="POST">
    <input type="hidden" name="command" value="unconfirmed_contracts">
    <input type="submit" value="${contract_unconfirmed_text}" />
</form>

<form action="/controller" method="POST">
    <input type="hidden" name="command" value="manager_contracts">
    <input type="submit" value="${contract_confirmed_text}" />
</form>
        ...
        <tr class="car">
            ...
            <td>
                <c:if test = "${contract.state == 'unconfirmed'}">
                    ...
                    <form action="/controller" method="POST">
                        <input type="hidden"  name="command" value="confirm_rent" />
