...
<div class="wrapper">
  ...
  <form name="form" action="controller" method="post" onsubmit="return validate()">
      ...
      <div>
        ...
        <input class="user-input" type="text" name="email" id="name" placeholder="My email is ..."  />
      </div> 
      <div>
        ...
        <input type="password" name="password" id="name" placeholder="My password is ..." />
      </div> 
     <div>
